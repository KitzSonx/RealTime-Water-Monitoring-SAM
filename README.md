# 🌊 Real-Time Water Level Monitoring using SAM

เป็นระบบเฝ้าระวังระดับน้ำแบบ Real-Time โดยใช้ Computer Vision และ **Segment Anything Model (SAM)** เพื่ออ่านระดับน้ำจากแถบวัดผ่านกล้อง IP Camera, เก็บหลักฐานภาพลง Google Drive, และส่งการแจ้งเตือนอัตโนมัติไปยัง LINE
...
โปรเจคนี้มีการเชื่อมต่อกับ API ภายนอก (LINE, Google Drive)
